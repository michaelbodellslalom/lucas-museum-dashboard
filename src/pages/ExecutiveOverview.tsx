...
const kpiGroupOrder: KpiGroup[] = ['Revenue', 'Fundraising', 'Admissions & Experience', 'Membership', 'Events']
  ...
  return (
    <div className="page executive-page">
      ...
      <section aria-labelledby="kpi-title">
        <div className="section-heading"><div><span className="section-kicker">Commercial health</span><h2 id="kpi-title">Revenue, fundraising &amp; summary KPIs</h2></div>{data && <p>Compared with {data.comparisonLabel}.</p>}</div>
