    ...
    <div className="page operations-page">
      ...
      <div className="operations-band">
        ...
        <section className="ops-subsection" aria-labelledby="transport-title">
          ...
          <div className="two-column-grid">
            ...
            <ChartCard title="Arrival volume by hour" subtitle="Ticket scan and parking-entry proxy" badge="quality-review"><AreaPairChart data={data.salesAttendance} label="Visitor arrivals and checked-in attendance by hour" firstName="Ticket demand" secondName="Checked in" /></ChartCard>
          </div>
      ...
      <div className="operations-band digital-band">
        ...
        <div className="chart-grid">
          ...
          <ChartCard title="Ticket-purchase funnel" subtitle="Click-through and abandonment by step" badge="quality-review" insight="Checkout start to purchase complete was the largest revenue-impacting drop-off." action="Segment payment abandonment by device and tender type."><FunnelChart data={data.funnel} /></ChartCard>
