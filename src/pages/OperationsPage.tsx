    ...
    <div className="page operations-page">
      ...
      <section aria-labelledby="glance-title">
        ...
        <div className="mini-metric-grid operating-picture-grid">
          ...
          <MiniMetric icon={Clock3} label="Avg Museum Visit Duration" value="3h 08m" detail={`vs. ${data.comparisonLabel}`} comparison={{ direction: 'up', label: '11 min', tone: 'bad' }} definition="Average elapsed time between visitor arrival and departure during the selected period." />
